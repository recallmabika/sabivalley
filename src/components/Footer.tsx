      ...
      <div className="container mx-auto px-4 lg:px-8 py-16 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-300">
              ...
              <li><Link href="#garden" className="hover:text-[#C27D38] transition-colors">Herbal Garden</Link></li>
        ...
        <div className="mt-16 pt-8 border-t border-[#1B3B2B] flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            ...
            <a href="#" className="text-gray-400 hover:text-[#C27D38] transition-colors" aria-label="X (Twitter)">
